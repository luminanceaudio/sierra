...
class Code extends Node_1.Node {
    ...
    generateCodeWithImports(opts) {
        const { path = "", forceDefaultImport, forceModuleImport, forceRequireImport = [], prefix, importMappings = {}, } = opts || {};
        ...
        const importPart = (0, Import_1.emitImports)(imports, ourModulePath, importMappings, forceRequireImport);
