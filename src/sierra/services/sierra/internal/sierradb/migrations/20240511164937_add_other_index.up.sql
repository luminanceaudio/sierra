...
CREATE TABLE `source_samples` (`uri` text NOT NULL, `source` text NULL, `sample` text NULL, PRIMARY KEY (`uri`), CONSTRAINT `source_samples_sources_source` FOREIGN KEY (`source`) REFERENCES `sources` (`uri`) ON DELETE SET NULL, CONSTRAINT `source_samples_samples_sample` FOREIGN KEY (`sample`) REFERENCES `samples` (`sha256`) ON DELETE SET NULL);
